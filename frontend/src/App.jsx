...
function App() {
  ...
  const handlePredict = async () => {
    ...
    // Initialize results array with loading states
    ...
    const processingPromises = selectedFiles.map(async (fileItem) => {
      ...
      let result = initialResults.find(r => r.id === fileItem.id) || { id: fileItem.id, fileName: fileItem.file.name, isLoading: true }; // Find existing result or create placeholder
